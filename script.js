const questions = [
  ...
  {
    question: "Who is the first player to drafted #1 with out playing college or highschool basketball in the NBA?",
    choices: ["Luka Doncic","Yoa Ming","Dikembe Mutombo","Giannis Antetokounmpo"],
    answer: "Yao Ming",
  },
  {
    question: "Which team drafted Kobe Bryant in 1996?",
    choices: ["Charlotte Hornets","Los Angelas Lakers","Chicago Bulls","New York Knicks"],
    answer: "Charlotte Hornets",
  },
  {
    question: "Which team has won the most consecutive NBA titles?",
    choices: ["Detroit Pistons","Boston Celtics","Los Angelas Lakers","Chicago Bulls"],
    answer: "Boston Celtics",
  },
  {
    question: "Which player has won the most NBA dunk contests?",
    choices: ["Dominique Wilkins","Aaron Gordon","Michael Jordan","Nate Robinson"],
  ...
  },
  {
    ...
    choices: ["Kobe Bryant","Lebron James","Michael Jordan","Wilt Chamberlin"],
    answer: "Lebron James",
  },
  {
    question: "Which team owns the record for the longest winning streak in NBA history?",
    choices: ["Chicago Bulls","Golden State Warriors","Los Angelas Lakers","Miami Heat"],
